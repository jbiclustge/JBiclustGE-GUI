...
/**
 * The Class TopGOAnalyserGUI.
 */
public class TopGOAnalyserGUI extends AbstractGeneEnrichmentAnalyserGUI{
	...
	/**
	 * Instantiates a new top GO analyser GUI.
	 */
	public TopGOAnalyserGUI(){
		super();
	}
