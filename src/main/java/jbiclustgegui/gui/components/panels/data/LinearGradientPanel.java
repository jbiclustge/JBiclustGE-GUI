...
public class LinearGradientPanel  extends JPanel{
	...
	/** The mean color. */
	private Color meanColor=Color.BLACK;
	...
	private Color endColor=Color.RED;
	  ...
	  /**
  	 * Instantiates a new linear gradient panel.
  	 */
  	 ...
  	 * @param meanColor the mean color
  	 * @param endColor the end color
  	 */
  	public LinearGradientPanel(Color startColor,Color meanColor, Color endColor){
		    this(HORIZONTAL);
  	 ...
  	 */
  	public LinearGradientPanel( int direction ){
	 ...
	 * Sets the mean color.
	 *
	 * @param meanColor the new mean color
	 */
	...
	public int getDirection() {
  	...
  	public void paintComponent( Graphics g )
	  {
	    ...
	    switch( direction ){
	    	case HORIZONTAL :
	    	{
	    		paint=new LinearGradientPaint(0, height / 2, width, height / 2, fractions, new Color[] {startColor,meanColor,endColor});
	    		//paint = new GradientPaint( 0, height / 2, startColor, width, height / 2, endColor, cyclic );
	    		break;
	    	}
	    	case VERTICAL :
	    	{
	    		paint=new LinearGradientPaint(width / 2, 0,  width / 2, maxLength > 0 ? maxLength : height, fractions, new Color[] {startColor,meanColor,endColor});
  	...
  	public static void main(String args[]) {
		    ...
		    LinearGradientPanel g=new LinearGradientPanel();
		    g.setDirection(0);
