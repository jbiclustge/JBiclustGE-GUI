...
import jbiclustgegui.gui.components.panels.chart.heatmap.BiclusterHeatmapJFreeChartPlotPanel;
...
/**
 * The Class BiclusterHeatmapViewDialog.
 */
public class BiclusterHeatmapViewDialog extends JDialog implements ActionListener{
	...
	private BiclusterHeatmapJFreeChartPlotPanel dataMatrixPanel;
	...
	public static void main(String[] args) {
		try {
			BiclusterHeatmapViewDialog dialog = new BiclusterHeatmapViewDialog();
	...
	/**
	 * Instantiates a new bicluster heatmap view dialog.
	 */
	public BiclusterHeatmapViewDialog() {
		initGUI();
	}
	...
	private void initGUI() {
		...
		{
			dataMatrixPanel = new BiclusterHeatmapJFreeChartPlotPanel();
	...
	public int showOpenDialog(BiclusterResult bicluster,int index, Component parent) throws HeadlessException, InterruptedException {
		...
		dataMatrixPanel.loadBiclusterHeatMap(bicluster,null);
