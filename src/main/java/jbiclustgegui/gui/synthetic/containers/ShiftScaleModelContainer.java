...
import jbiclustge.analysis.syntheticdata.factory.modeltype.ShiftScaleSyntheticDataBuilder;
import jbiclustge.analysis.syntheticdata.factory.props.SyntheticDataProperties;

// TODO: Auto-generated Javadoc
/**
 * The Class ShiftScaleModelContainer.
 */
public class ShiftScaleModelContainer implements IBiclusterModelDataFactory {

	
	 /** The builder. */
 	private ShiftScaleSyntheticDataBuilder builder;
	 ...
	 /**
 	 * Instantiates a new shift scale model container.
 	 *
 	 * @param dataprops the dataprops
 	 * @param modelprops the modelprops
 	 */
 	public ShiftScaleModelContainer(SyntheticDataProperties dataprops, Map<String, Object> modelprops) {
 	...
 	private void configureBuilder(SyntheticDataProperties dataprops, Map<String, Object> modelprops) { 
		 ...
		 ShiftScaleBiclusterFactory bicfactory=new ShiftScaleBiclusterFactory(dist,
		 ...
		 builder=new ShiftScaleSyntheticDataBuilder(dataprops, bicfactory);
	...
	public BiclusterModelType getTypeBiclusterModel() {
		return BiclusterModelType.SHIFTSCALE;
	}
