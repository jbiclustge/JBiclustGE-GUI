...
/**
 * The Class ConstantAdditiveRowAdjModelContainer.
 */
public class ConstantAdditiveRowAdjModelContainer implements IBiclusterModelDataFactory {
	 ...
	 /**
 	 * Instantiates a new constant additive row adj model container.
 	 *
 	 * @param dataprops the dataprops
 	 * @param modelprops the modelprops
 	 */
 	public ConstantAdditiveRowAdjModelContainer(SyntheticDataProperties dataprops, Map<String, Object> modelprops) {
	...
	public BiclusterModelType getTypeBiclusterModel() {
		return BiclusterModelType.CONSTANTADDROWADJ;
	}
