...
/**
 * The Class ConstantModelContainer.
 */
public class ConstantModelContainer implements IBiclusterModelDataFactory {
	 ...
	 /** The constantsignal. */
 	public static String CONSTANTSIGNAL="CONSTANTSIGNAL";
	 ...
	 /**
 	 * Instantiates a new constant model container.
 	 *
 	 * @param dataprops the dataprops
 	 * @param modelprops the modelprops
 	 */
 	public ConstantModelContainer(SyntheticDataProperties dataprops, Map<String, Object> modelprops) {
 	...
 	private void configureBuilder(SyntheticDataProperties dataprops, Map<String, Object> modelprops) { 
		 ...
		 bicfactory.setBiclusterCommonSignal((int) modelprops.get(CONSTANTSIGNAL));
	...
	public BiclusterModelType getTypeBiclusterModel() {
		return BiclusterModelType.CONSTANT;
	}
