...
/**
 * The Class ConstantMultiplicativeRowAdjModelContainer.
 */
public class ConstantMultiplicativeRowAdjModelContainer implements IBiclusterModelDataFactory {
	 ...
	 /**
 	 * Instantiates a new constant multiplicative row adj model container.
 	 *
 	 * @param dataprops the dataprops
 	 * @param modelprops the modelprops
 	 */
 	public ConstantMultiplicativeRowAdjModelContainer(SyntheticDataProperties dataprops, Map<String, Object> modelprops) {
 	...
 	private void configureBuilder(SyntheticDataProperties dataprops, Map<String, Object> modelprops) { 
		 ...
		 constrowadj.setMultiplicativeAdjustment();
		 constrowadj.setRowsAdjustment(); 
	...
	public BiclusterModelType getTypeBiclusterModel() {
		return BiclusterModelType.CONSTANTMULTROWADJ;
	}
