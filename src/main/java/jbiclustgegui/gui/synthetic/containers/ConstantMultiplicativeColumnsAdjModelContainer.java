...
/**
 * The Class ConstantMultiplicativeColumnsAdjModelContainer.
 */
public class ConstantMultiplicativeColumnsAdjModelContainer implements IBiclusterModelDataFactory {
	 ...
	 /**
 	 * Instantiates a new constant multiplicative columns adj model container.
 	 *
 	 * @param dataprops the dataprops
 	 * @param modelprops the modelprops
 	 */
 	public ConstantMultiplicativeColumnsAdjModelContainer(SyntheticDataProperties dataprops, Map<String, Object> modelprops) {
	...
	public BiclusterModelType getTypeBiclusterModel() {
		return BiclusterModelType.CONSTANTMULTCOLUMNADJ;
	}
