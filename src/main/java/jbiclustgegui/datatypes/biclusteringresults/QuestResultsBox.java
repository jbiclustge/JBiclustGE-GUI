...
/**
 * The Class QuestResultsBox.
 */
public class QuestResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new quest results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public QuestResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.QUEST);
	}
