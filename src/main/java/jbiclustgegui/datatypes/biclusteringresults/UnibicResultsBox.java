...
/**
 * The Class UnibicResultsBox.
 */
public class UnibicResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new unibic results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public UnibicResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.UNIBIC);
	}
