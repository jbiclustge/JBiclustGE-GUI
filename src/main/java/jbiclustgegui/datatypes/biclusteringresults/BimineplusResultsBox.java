...
/**
 * The Class BimineplusResultsBox.
 */
public class BimineplusResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new bimineplus results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BimineplusResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BIMINEPLUS);
	}
