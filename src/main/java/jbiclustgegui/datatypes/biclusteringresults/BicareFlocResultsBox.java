...
/**
 * The Class BicareFlocResultsBox.
 */
public class BicareFlocResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new bicare floc results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BicareFlocResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BICARE);
	}
