...
/**
 * The Class BiclicResultsBox.
 */
public class BiclicResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new biclic results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BiclicResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BICLIC);
	}
