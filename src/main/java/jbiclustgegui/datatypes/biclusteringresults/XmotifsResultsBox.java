...
/**
 * The Class XmotifsResultsBox.
 */
public class XmotifsResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new xmotifs results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public XmotifsResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.XMOTIFS);
	}
