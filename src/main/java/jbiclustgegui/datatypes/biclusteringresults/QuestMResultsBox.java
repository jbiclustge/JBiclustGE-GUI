...
/**
 * The Class QuestMResultsBox.
 */
public class QuestMResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new quest M results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public QuestMResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.QUESTMET);
	}
