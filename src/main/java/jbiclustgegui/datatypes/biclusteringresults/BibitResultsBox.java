...
/**
 * The Class BibitResultsBox.
 */
public class BibitResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new bibit results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BibitResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BIBIT);
	}
