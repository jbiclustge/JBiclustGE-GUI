...
/**
 * The Class ChengAndChurchResultsBox.
 */
public class ChengAndChurchResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new cheng and church results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public ChengAndChurchResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.CC);
	}
