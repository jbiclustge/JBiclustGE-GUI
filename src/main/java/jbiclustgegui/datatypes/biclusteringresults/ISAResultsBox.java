...
/**
 * The Class ISAResultsBox.
 */
public class ISAResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new ISA results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public ISAResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.ISA);
	}
