...
/**
 * The Class SpectralResultsBox.
 */
public class SpectralResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new spectral results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public SpectralResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.SPECTRAL);
	}
