...
/**
 * The Class BBCResultsBox.
 */
public class BBCResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new BBC results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BBCResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BBC);
	}
