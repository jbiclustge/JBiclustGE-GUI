...
/**
 * The Class PlaidResultsBox.
 */
public class PlaidResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new plaid results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public PlaidResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.PLAID);
	}
