...
/**
 * The Class QuestORDResultsBox.
 */
public class QuestORDResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new quest ORD results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public QuestORDResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.QUESTORD);
	}
