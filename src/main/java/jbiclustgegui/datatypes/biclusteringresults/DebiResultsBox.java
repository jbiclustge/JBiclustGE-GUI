...
/**
 * The Class DebiResultsBox.
 */
public class DebiResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new debi results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public DebiResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.DEBI);
	}
