...
/**
 * The Class COALESCEResultsBox.
 */
public class COALESCEResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new COALESCE results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public COALESCEResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.COALESCE);
	}
