...
/**
 * The Class FabiaSResultsBox.
 */
public class FabiaSResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new fabia S results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public FabiaSResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.FABIAS);
	}
