...
/**
 * The Class OPSMResultsBox.
 */
public class OPSMResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new OPSM results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public OPSMResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.OPSM);
	}
