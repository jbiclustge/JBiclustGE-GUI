...
/**
 * The Class FabiaResultsBox.
 */
public class FabiaResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new fabia results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public FabiaResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.FABIA);
	}
