...
/**
 * The Class BicFinderResultsBox.
 */
public class BicFinderResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new bic finder results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BicFinderResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BICFINDER);
	}
