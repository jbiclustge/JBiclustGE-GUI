...
/**
 * The Class BimaxResultsBox.
 */
public class BimaxResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new bimax results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public BimaxResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.BIMAX);
	}
