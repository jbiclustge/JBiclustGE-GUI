...
/**
 * The Class CPBResultsBox.
 */
public class CPBResultsBox extends BiclusteringResultBox{

	/**
	 * Instantiates a new CPB results box.
	 *
	 * @param name the name
	 * @param proj the proj
	 * @param results the results
	 */
	public CPBResultsBox(String name, Project proj, BiclusterList results) {
		super(name, proj, results, BiclusteringMethod.CPB);
	}
